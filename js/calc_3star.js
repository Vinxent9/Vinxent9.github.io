	...
	function refresh_chart(star1_level, star2_level,star1_name,star2_name,type1,type2,calculate=0,star3_level=0,star3_name='',type3=''){
		$("#line_chart").show();
		...
		//star 3
		if(star3_name != ''){ //get st cd of star III

			s3time = new Array(limit-1);
			for(var x=0; x < star_data.length; x++){
				if(star_data[x][0] == star3_name){
					cd_index = star3_level*2;
					st_index = cd_index - 1;
					cd = star_data[x][cd_index];
					st = star_data[x][st_index];
				}
			...
			switch (type3) {
			  case "Dancer":
			    myChart.data.datasets[2].backgroundColor = 'rgba(239, 154, 154, 1)';
			    myChart.data.datasets[2].borderColor = 'rgba(239, 154, 154, 1)';
			    myChart.data.datasets[2].hoverBorderColor = 'rgba(239, 154, 154, 1)';
			    break;
			  case "Vocal":
			    myChart.data.datasets[2].backgroundColor = 'rgba(157, 191, 249, 1)';
			    myChart.data.datasets[2].borderColor = 'rgba(157, 191, 249, 1)';
			    myChart.data.datasets[2].hoverBorderColor = 'rgba(157, 191, 249, 1)';
			    break;
			  case "Session":
			    myChart.data.datasets[2].backgroundColor = 'rgba(165, 214, 167, 1)';
			    myChart.data.datasets[2].borderColor = 'rgba(165, 214, 167, 1)';
			    myChart.data.datasets[2].hoverBorderColor = 'rgba(165, 214, 167, 1)';
			    break;
			  default:
			}

			myChart.data.datasets[2].label = star3_name + " LV" + star3_level + " (3)"; //star 3 label
			myChart.data.datasets[2].data = s3time; //star 3 data
			myChart.data.datasets[2].hidden = false;
		}
		else{
			myChart.data.datasets[2].hidden = true; //hide data 3
		}
		...
		myChart.data.datasets[0].label = star1_name + " LV" + star1_level + " (1)"; //star 1 label
		myChart.data.datasets[1].label = star2_name + " LV" + star2_level + " (2)"; //star 2 label
	...
	function show_chart_click2(star1_level, star2_level,star3_level){
		refresh_chart(star1_level,star2_level,current_star1_name,current_star2_name,current_type1,current_type2,1,star3_level,current_star3_name,current_type3);
	}
...
//new 07/11/2020
$('body').on('change', '#star_name1,#star_name2,#star_name3', function(event) {  //change event for the 2 select boxes, use this when dealing with dynamic html elements for jQuery Events
...
//new for 3rd star optional
var ave_per_2 = new Array(1000);
var combo_time_2 = new Array(1000);
for (var i = 0; i < combo_time_2.length; i++) {
  combo_time_2[i] = new Array(7);
}
var combo_time_per_2 = new Array(1000);
for (var i = 0; i < combo_time_per_2.length; i++) {
  combo_time_per_2[i] = new Array(7);
}
//end of new

	function genTable(){
		table_h = "<table class='table table-striped  table-borderless table-sm table-dark' id='sktable' style='width:100%''> <tr> <th colspan='3'>Star 1</th> <th colspan='3'>Star 2</th> <th colspan='3'>Star 3</th> </tr> <tr> <th>LV</th> <th>Cool Down</th> <th>Skill Time</th>  <th>LV</th> <th>Cool Down</th> <th>Skill Time </th> <th>LV</th> <th>Cool Down</th> <th>Skill Time </th></tr>";
		table_b = "";
		table_f = "</table>";
		...
		for (i = 1; i <= 10; i++) {
		  table_b += "<tr><td><span class='badge badge-warning'>LV" + i + "</span></td><td><input class = 'form-control form-control-sm' type='text' min='1' step='1' id='star1cd" + i + "' readonly></td><td><input class = 'form-control form-control-sm' type='text' min='1' step='1' id='star1st" + i + "' readonly></td>" +
		  			"<td><span class='badge badge-warning'>LV" + i + "</span></td><td><input class = 'form-control form-control-sm' type='text' min='1' step='1' id='star2cd" + i + "' readonly></td><td><input class = 'form-control form-control-sm' type='text'' min='1' step='1' id='star2st" + i + "' readonly></td>" +
					"<td><span class='badge badge-warning'>LV" + i + "</span></td><td><input class = 'form-control form-control-sm' type='text' min='1' step='1' id='star3cd" + i + "' readonly></td><td><input class = 'form-control form-control-sm' type='text' min='1' step='1' id='star3st" + i + "' readonly></td></tr>";
		}
	...
	function genList(){
		...
		var slist3 = document.getElementById('starlist3');
		...
		slist3.innerHTML += "<select type='button' class='btn btn-outline-warning' id='star_name3' onchange='editTable3()' disabled>" + options + "</select>";
	}
	...
	function editTable1(){	
		...
		if(document.getElementById('star_name2').value != -1 && document.getElementById('star_name1').value != -1){
			...
			document.getElementById("star_name3").disabled = false; 
		}
		else{
			document.getElementById("calculate_btn").disabled = true;
			document.getElementById("star_name3").disabled = true;  
		}
	...
	function editTable3(){	
		var slist3detail = document.getElementById('starlist3detail');	
		slist3detail.innerHTML="";	
		if(document.getElementById('star_name3').value == -1){	
			for(e = 1; e <= 10; e++){	
				document.getElementById('star3cd'+e).value = "";	
				document.getElementById('star3st'+e).value = "";	
			}	
			slist3detail.innerHTML="";	
		}	
		else{	
			for(e = 1; e <= 10; e++){	
				document.getElementById('star3cd'+e).value = star_data[document.getElementById('star_name3').value][e*2];	
				document.getElementById('star3st'+e).value = star_data[document.getElementById('star_name3').value][(e*2)-1];	
			}	
			type = star_data[document.getElementById('star_name3').value][21];	
			if(type == "Dancer"){	
				color = "red";	
			}	
			else if(type == "Session"){	
			...
			// slist3detail.innerHTML += star_data[document.getElementById('star_name3').value][22] + " Note <font color ='" + color + "'>" + type + "</font> Star"; 	
		}	
	...
	function calculate(){
		...
		for(x = 1; x <= 10; x++){
			...
			for(y = 1; y <=10; y++){
                ...
                if(document.getElementById('star_name3').value != -1){	
                    for(z = 1; z <=10; z++){	
                        s3time = new Array(180);	
                        cd = parseInt(document.getElementById('star3cd'+z).value);	
                        st = parseInt(document.getElementById('star3st'+z).value);	
                        pointer = 0;	
                        while(pointer < 180){	
                            if(! ((pointer + cd) < 180)){	
                                cd = 180 - pointer;	
                        ...
                        for(var ind = 0; ind < 180; ind++){	
                            if(s1time[ind] == true || s2time[ind] == true || s3time[ind] == true){	
                                combo_s_2++;	
                            }
							if(ind == 29){
								combo_time_2[combo_time_pointer_2][0] = combo_s_2;
								combo_time_per_2[combo_time_pointer_2][0] = combo_s_2/30;
							}
							if(ind == 59){
								combo_time_2[combo_time_pointer_2][1] = combo_s_2;
								if(perType == 0){
									combo_time_per_2[combo_time_pointer_2][1] = combo_s_2/60;
								}
								else{
									combo_time_per_2[combo_time_pointer_2][1] = (combo_s_2 - combo_time_2[combo_time_pointer_2][0])/30;
								}
							}	
                           if(ind == 89){
								combo_time_2[combo_time_pointer_2][2] = combo_s_2;
								if(perType == 0){
									combo_time_per_2[combo_time_pointer_2][2] = combo_s_2/90;
								}
								else{
									combo_time_per_2[combo_time_pointer_2][2] = (combo_s_2 - combo_time_2[combo_time_pointer_2][1])/30;
								}
							}
							if(ind == 119){
								combo_time_2[combo_time_pointer_2][3] = combo_s_2;
								if(perType == 0){
									combo_time_per_2[combo_time_pointer_2][3] = combo_s_2/120;
								}
								else{
									combo_time_per_2[combo_time_pointer_2][3] = (combo_s_2 - combo_time_2[combo_time_pointer_2][2])/30;
								}
							}
							if(ind == 149){
								combo_time_2[combo_time_pointer_2][4] = combo_s_2;
								if(perType == 0){
									combo_time_per_2[combo_time_pointer_2][4] = combo_s_2/150;
								}
								else{
									combo_time_per_2[combo_time_pointer_2][4] = (combo_s_2 - combo_time_2[combo_time_pointer_2][3])/30;
								}
							}
							if(ind == 179){
								combo_time_2[combo_time_pointer_2][5] = combo_s_2;
								if(perType == 0){
									combo_time_per_2[combo_time_pointer_2][5] = combo_s_2/180;
								}
								else{
									combo_time_per_2[combo_time_pointer_2][5] = (combo_s_2 - combo_time_2[combo_time_pointer_2][4])/30;
								}
							}
							if(ind == (custom_time - 1)){
								combo_time_2[combo_time_pointer_2][6] = combo_s_2;
								combo_time_per_2[combo_time_pointer_2][6] = combo_s_2/custom_time;
							}	
						}	
                        ave_per_2[combo_time_pointer_2] = ((combo_time_per_2[combo_time_pointer_2][0]+ combo_time_per_2[combo_time_pointer_2][1] +combo_time_per_2[combo_time_pointer_2][2] + combo_time_per_2[combo_time_pointer_2][3] + combo_time_per_2[combo_time_pointer_2][4] + combo_time_per_2[combo_time_pointer_2][5]) /6);	
                        combo_time_pointer_2 ++;	
                    }	
                }	
                //end of new 
	...
	function printResults(){
		...
		if(document.getElementById('star_name3').value != -1){	
            var star3_level = 0;	
            var star3_name = star_data[document.getElementById('star_name3').value][0];	
            var type3 = star_data[document.getElementById('star_name3').value][21];	
            var color3 = "";	

            //new for chart
            current_star3_name = star3_name;
            current_type3 = type3;
            //end of new
        ...
        if(document.getElementById('star_name3').value != -1){	
            ...
            highest = (highest*100).toFixed(2);	
            star1_level = (Math.floor(index / 100) ) + 1 ;	
            index = index - ((star1_level-1)*100);	
            star2_level = (Math.floor(index / 10) ) + 1 ;	
            star3_level = (index % 10) + 1;	
            index = index + ((star1_level-1)*100);	
            //alert(star1_level + "/" + star2_level + "/" + star3_level + "/" + highest + "%");	
            //print results	
            results += "<div class='card text-white bg-dark'> <img src='asset/taptoptoolbg_result_3stars.jpg' class='card-img-top'><div class='card-body'><p>The best possible combination is <b><font color='" + color1 +"'>" + star1_name +  "</font></b> Skill Level <b>" + star1_level + "</b> and <b><font color='" + color2 + "'>" + star2_name + "</font></b> Skill Level <b>" + star2_level + "</b> and <b><font color='" + color3 + "'>" + star3_name + "</font></b> Skill Level <b>" + star3_level + "</b> with an average percentage of <b style=color:#FFE082><i>" + highest + "%</b></i></p><br><a class='btn btn-warning rounded-pill' href='javascript:show_chart_click2(" + star1_level + "," + star2_level + "," + star3_level + ")' role='button'><strong>View Skill Time Graph</strong> <i class='fas fa-chart-bar'></i></a></div></div>";		
            results += "<br><table class = 'table' style=text-align:center><tr><th scope='col' class='bg-warning'>30 Seconds</th><th scope='col' class='bg-warning'>60 Seconds</th><th scope='col' class='bg-warning'>90 Seconds</th><th scope='col' class='bg-warning'>120 Seconds</th><th scope='col' class='bg-warning'>150 Seconds</th><th scope='col' class='bg-warning'>180 Seconds</th></tr>" +	
            "<tr class='table-secondary'><td>" + combo_time_2[index][0] + " Seconds</td><td>" + combo_time_2[index][1] + " Seconds</td><td>" + combo_time_2[index][2] + " Seconds</td><td>" + combo_time_2[index][3] + " Seconds</td><td>" + combo_time_2[index][4] + " Seconds</td><td>" + combo_time_2[index][5] + " Seconds</td></tr>"+	
            "<tr class='table-secondary'><td>" + (combo_time_per_2[index][0]*100).toFixed(2) + "%</td><td>" + (combo_time_per_2[index][1]*100).toFixed(2) + "%</td><td>" + (combo_time_per_2[index][2]*100).toFixed(2) + "%</td><td>" + (combo_time_per_2[index][3]*100).toFixed(2) + " %</td><td>" + (combo_time_per_2[index][4]*100).toFixed(2) + " %</td><td>" + (combo_time_per_2[index][5]*100).toFixed(2) + " %</td> </tr>" +	
            "</table>";	
            	

            results += "<br/><br/>";	

            refresh_chart(star1_level,star2_level,current_star1_name,current_star2_name,current_type1,current_type2,0,star3_level,current_star3_name,current_type3);
        }	
        //custom time for 3rd star 	
        if((custom_time > 0 && custom_time <= 180) && (document.getElementById('star_name3').value != -1)){	
            highest = 0;	
            for(r=0;r < 1000; r++){	
                per_temp = combo_time_per_2[r][6];	
                if(per_temp >= highest){	
                    highest = per_temp;	
                    index = r;	
                }	
            ...
            //alert(star1_level + "/" + star2_level + "/" + star3_level + "/" + highest + "%");	
            //print results	
            results += "<div class='card text-white bg-dark'> <img src='asset/taptoptoolbg_result_3stars_cust.jpg' class='card-img-top'><div class='card-body'><p>The best possible combination (in <b>" + custom_time + "</b> seconds) is <b><font color='" + color1 +"'>" + star1_name +  "</font></b> Skill Level <b>" + star1_level + "</b> and <b><font color='" + color2 + "'>" + star2_name + "</font></b> Skill Level <b>" + star2_level + "</b> and <b><font color='" + color3 + "'>" + star3_name + "</font></b> Skill Level <b>" + star3_level + "</b> with an average percentage of <b style=color:#FFE082><i>" + highest + "%</b></i></p><br><a class='btn btn-warning rounded-pill' href='javascript:show_chart_click2(" + star1_level + "," + star2_level + "," + star3_level + ")' role='button'><strong>View Skill Time Graph</strong> <i class='fas fa-chart-bar'></i></a></div></div>";		
            results += "<br><table class = 'table table-sm' style=text-align:center><tr><th class='bg-warning'>" + custom_time + " Seconds</th></tr>" +	
			"<tr class='table-secondary'><td>" + combo_time_2[index][6] + " Seconds</td></tr>"+	
			"<tr class='table-secondary'><td>" + (combo_time_per_2[index][6]*100).toFixed(2) + "%</td></tr>" +	
			"</table>";	
		...
		while(s2 < 10){
			...
			s2_table += "<tr><td rowspan='2' style=padding-top:1em><b>LV"+ s2_level +"</b></td><td rowspan='2' style=padding-top:1em><b>LV" + s21_level + "</b></td><td>" + combo_time[s2_index][0] + " Seconds</td><td>" + combo_time[s2_index][1] + " Seconds</td><td>" + combo_time[s2_index][2] + " Seconds</td><td>" + combo_time[s2_index][3] + " Seconds</td><td>" + combo_time[s2_index][4] + " Seconds</td><td>" + combo_time[s2_index][5] + " Seconds</td><td rowspan='2' style=padding-top:1em><b><i><a class='btn btn-warning btn-sm' href='javascript:show_chart_click(" + s21_level + "," + s2_level + ");' role='button'><strong>" + (ave_per[s2_index]*100).toFixed(2) + "%</a></strong></b></i></td></tr>";
		...
		if(custom_time > 0 && custom_time <= 180){
			...
			while(s1 < 100){
				...
				s1_table += "<tr><td rowspan='2' style=padding-top:1em><b>LV"+ s1_level +"</b></td><td rowspan='2' style=padding-top:1em><b>LV" + s12_level + "</b></td><td>" + combo_time[s1_index][6] + " Seconds</td><td rowspan='2' style=padding-top:1em><i><a class='btn btn-warning btn-sm' href='javascript:show_chart_click(" + s1_level + "," + s12_level + ");' role='button'><strong>" + (combo_time_per[s1_index][6]*100).toFixed(2) + "%</i></strong></a></td></tr>";
			...
			while(s2 < 10){
				...
				s2_table += "<tr><td rowspan='2' style=padding-top:1em><b>LV"+ s2_level +"</b></td><td rowspan='2' style=padding-top:1em><b>LV" + s21_level + "</b></td><td>" + combo_time[s2_index][6] + " Seconds</td><td rowspan='2' style=padding-top:1em><i><a class='btn btn-warning btn-sm' href='javascript:show_chart_click(" + s21_level + "," + s2_level + ");' role='button'><strong>" + (combo_time_per[s2_index][6]*100).toFixed(2) + "%</i></strong></a></td></tr>";
		...
		while(s1 < 100){
			for(s = 0; s < 10; s++){	
				...
				s1_table += "<tr><td rowspan='2' style=padding-top:1em><b>LV"+ s1_level +"</b></td><td rowspan='2' style=padding-top:1em><b>LV" + s12_level + "</b></td><td>" + combo_time[s+s1][0] + " Seconds</td><td>" + combo_time[s+s1][1] + " Seconds</td><td>" + combo_time[s+s1][2] + " Seconds</td><td>" + combo_time[s+s1][3] + " Seconds</td><td>" + combo_time[s+s1][4] + " Seconds</td><td>" + combo_time[s+s1][5] + " Seconds</td><td rowspan='2' style=padding-top:1em><b><i><a class='btn btn-warning btn-sm' href='javascript:show_chart_click(" + s1_level + "," + s12_level + ");' role='button'><strong>" + (ave_per[s+s1]*100).toFixed(2) + "%</a></strong></b></i></td></tr>";
